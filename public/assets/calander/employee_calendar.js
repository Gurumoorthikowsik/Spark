...
class CalendarYvv{
    ...
    createDayTag(){
        ...
        var cont = $("<div class='vijay1 d-flex border w-100 border-top-0 "+this.bg+" "+this.textColor+"'>");

        diasOrd.fechCort.forEach(function(e){
            var div = $("<div class='vijay1 d-flex border flex-fill w-100 justify-content-center p-2'>").html(e);
            cont.append(div);
        });
        return cont;
    }
    createDaysMont(){
        ...
        var cont = $("<div class='vijay2 d-flex border w-100 border-top-0'>");
        var emptyTag = "<div class='vijay2 d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn' style='color:transparent'>";
        ...
        for(var i=0;i<this.cantDias;i++){
            ...
            var div = $("<div class='click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"'>").html(i+1);
            var clas_e = this;
            var _ind = (this.cantDias+posMes)%7;

            //dia seleccionado
            if(this.diaSeleccionado==fechNow){
                div = $("<div class='current-date-selected click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"'>").html(i+1);
            }
            ...
            if(this.obsend.indexOf(i+1)!=-1){
                div = $("<div class='click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"' style='background: "+this.obsendClr+"; color: "+this.textResalt+"; font-weight: bold;'>").html(i+1);
            }


            if(this.low_working_day.indexOf(i+1)!=-1){
                div = $("<div class='click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"' style='background: "+this.low_working_dayClr+"; color: "+this.textResalt+"; font-weight: bold;'>").html(i+1);
            }

            

            if(this.precent.indexOf(i+1)!=-1){
                div = $("<div class='click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"' style='background: "+this.precentClr+"; color: "+this.textResalt+"; font-weight: bold;'>").html(i+1);
            }

            if(this.leavedays.indexOf(i+1)!=-1){
                div = $("<div class='click_calendar d-flex border flex-fill w-100 justify-content-center pt-3 pb-3 btn "+this.btnD+"' data-date='"+fechNow+"' style='background: "+this.leaveClr+"; color: "+this.textResalt+"; font-weight: bold;'>").html(i+1);
            }
