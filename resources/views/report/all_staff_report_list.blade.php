                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Working Report Staff List</h5>
                                    </div><!--end col-->
                                        ...
                                        <tr class="item">
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div class="edit">
                                                        <a href="{{URL::to('/view_staff_working')}}/{{encrypt_decrypt('encrypt',$value->userid)}}"><button class="btn btn-sm btn-success edit-item-btn">View</button></a>
                                                    </div>
...
<script type="text/javascript">
	$('select').on('change', function() {
	  ...
	  window.location.href = base_url+"/staff_working_report/"+this.value;
