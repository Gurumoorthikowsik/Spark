                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Staff Leave Request</h5>
                                    </div><!--end col-->
                                 ...
                                 <table id="example" class="display nowrap " style="width:100%">
                                        <thead>
                                            <tr>
                                                 ...
                                                 <th class="sort" data-sort="date">Leave Date</th>
                                                 <th class="sort" data-sort="currency_name">Day</th>                                                 
                                                 <th class="sort" data-sort="type">Reason</th>
                                                 <th class="sort" data-sort="type">Section</th>
                                                 <th class="sort" data-sort="type">Status</th>
                                                 <th class="sort" data-sort="type">Apply Date</th>
                                                 @if(page_access(user_id(),'edit_Leave_Request') == 1)
                                        ...
                                        @php $i = 1; @endphp
                                        @foreach ($leave_request->get() as $value)
                                        ...
                                        <tr class="item">
                                            ...
                                            <td class="currency_name">{{$value->leave_date}}</td> 
                                            <td class="currency_name">{{$value->day}}</td> 
                                            <td class="currency_name">{{$value->reason}}</td> 
                                            <td class="currency_name">{{$value->Section}}</td> 
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Staff Leave Action</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('/'); ?>/leave_request" id="add-inventory-form" class="add-inventory-form" method="post" autocomplete="off">
                        {{ csrf_field() }}
