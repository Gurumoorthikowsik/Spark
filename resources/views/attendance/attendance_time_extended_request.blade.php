                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Attendance Time Extend Request</h5>
                                    </div><!--end col-->
                                 ...
                                 <table id="example" class="display nowrap " style="width:100%">
                                        <thead>
                                            <tr>
                                                 ...
                                                 <th class="sort" data-sort="form_name" scope="col">Extend Date</th>
                                                 ...
                                                 @if(page_access(user_id(),'edit_Attendance_Time_Extend_Request') == 1)
                                                 <th class="sort" data-sort="type">Action</th>
                                                 @endif
                                            </tr>
                                        </thead>
                                        <tbody class="list form-check-all">
                                        @if($attendance_time_extended_request->count() != 0)
                                        @php $i = 1; @endphp
                                        @foreach ($attendance_time_extended_request->get() as $value)

                                        <tr class="item">
                                            <td class="id">{{$i}}</td>
                                            <td class="form_name">{{$value->employee_id}}</td>
                                            <td class="form_name">{{$value->extend_date}}</td>
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Attendance Time Extend Action</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('/'); ?>/attendance_time_extended_request" id="add-inventory-form" class="add-inventory-form" method="post" autocomplete="off">
                        {{ csrf_field() }}
