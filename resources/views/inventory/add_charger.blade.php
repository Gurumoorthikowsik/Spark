                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Add Charger</h5>
                                    </div><!--end col-->
                                 ...
                                 <table id="os" class="display nowrap " style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="form_name" scope="col">Charger Type</th>                                               
                                        ...
                                        @if($add_charger->count() !== 0)
                                        @php $i = 1; @endphp
                                        @foreach ($add_charger->get() as $value)
                                            <tr>
                                                <td>{{$i}}</td>                                              
                                                <td>{{$value->charger_name}} </td>
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Add Charger</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('inventory/'); ?>/add_os_submit" id="add_os" class="laptop-form" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="modal-body">

                            <div class="mb-3">
                                <label for="customername-field" class="form-label"> Charger * </label>
                                <input type="text" class="form-control" name="os_name" id="os_name" class="hhhhhh"
                                placeholder="Enter The Charger Name">
                            </div>                        
...
<div class="modal fade" id="showModaledit" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Edit Charger List</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('/'); ?>/edit_add_os" id="edit_add-os-form" class="edit_add-os-form" method="post" autocomplete="off">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="customername-field" class="form-label">Charger Name * </label>
