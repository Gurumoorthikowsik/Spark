                                 ...
                                 <table id="example" class="table table-striped table-hover" style="width:100%">
                                        <thead>
                                            <tr>                                                
                                                ...
                                                <th class="sort" data-sort="currency_name">Brand</th>
                                                <th class="sort" data-sort="role">Accessories</th>  
                                                <th class="sort" data-sort="currency_name">Serial Number</th>
                                                <th class="sort" data-sort="role">Sim</th>
                                                <th  class="sort" data-sort="role">Sim Type</th>
                                        ...
                                        <tr class="item">
                                            ...
                                            <td class="currency_name">{{get_brand($value->brand)}}</td>
                                            <td class="role">{{get_accessories($value->accessories)}}</td>
                                            <td class="currency_name">{{$value->serial_no}}</td>
                                            <td class="role">{{get_sim($value->sim)}}</td> 
                                            <td class="role">{{get_simcard($value->simcard)}}</td>
