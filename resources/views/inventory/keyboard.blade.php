                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Keyboard Details </h5>
                                    </div><!--end col-->
                                    <div class="col-md-auto ms-auto">
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="container">
                                                  <div class="row">
                                                    <div class="col-sm">
                                                      <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Keyboard</button>
                                                    </div>
                                                    <div class="col-sm">
                                 ...
                                 <table id="example" class="display nowrap " style="width:100%">
                                        ...
                                        <tr class="item">
                                            ...
                                            <div class="d-flex gap-2">
                                                    ...
                                                    <div class="edit">
                                                        <a href="{{URL::to('/inventory/keyboard_status')}}/{{encrypt_decrypt('encrypt',$value->id)}}"><button class="btn btn-sm btn-warning edit-item-btn"
                                                        >Status</button></a>
                                                    </div>
                                                    ...
                                                    <div class="remove">
                                                        <a onclick="return confirm('Are you sure you would delete the inventory ?');" href="{{URL::to('/inventory/delete_keyboard')}}/{{encrypt_decrypt('encrypt',$value->id)}}"><button class="btn btn-sm btn-danger remove-item-btn">Remove</button></a>
                                                    </div>
...
<!-- ==========================================================Table End====================================================================== -->
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Add Keyboard Details</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('inventory/'); ?>/keyboard" id="keyboard-form" class="keyboard-form" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                placeholder="Enter The Keyboard Brand Name">
                            </div>

                            <div class="mb-3">
                                <label for="email-field" class="form-label">Serial Number*</label>
                                <input type="text" class="form-control" name="serial_no" id="serial_no" placeholder="Enter The Keyboard Serial Number">
                            </div> 
                        ...
                        <div class="modal-footer">
                            <div class="hstack gap-2 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-success" id="keyboard-btn" type="submit" name="keyboard_btn" id="keyboard_btn" class="btn btn-success w-100" >Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
     ...
     <div class="modal fade" id="edit_report_model" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Edit Keyboard Details</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('inventory/'); ?>/edit_keyboard" id="edit-keyboard-form" class="edit-keyboard-form" method="post" autocomplete="off">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="customername-field" class="form-label">Brand * </label>
                            ...
                            <div class="mb-3">
                                <label for="email-field" class="form-label">Serial Number*</label>
                                <input type="text" class="form-control edit_serial_no" name="serial_no" id="serial_no" placeholder="Enter The Keyboard Serial Number">
                            </div> 
...
<script type="text/javascript">
    ...
    $('.edit_report').click(function(){
        ...
        $.ajax({
            url: inv_url+"/edit_get_keyboard/"+id,
            type: "POST",
...
<script type="text/javascript">
    $('select').on('change', function() {
      ...
      window.location.href = inv_url+"/keyboard/"+this.value;
