                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center mt-sm-5 mb-4 text-white-50">
                                <div>
                                    <a href="{{ URL::to('/') }}" class="d-inline-block auth-logo">
                                        <img src="{{ asset('assets/imageslogo-light.png')}}" alt="" height="20">
                                    </a>
                                </div>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body p-4"> 
                                    <div class="text-center mt-2">
                                        <h5 class="text-primary">Welcome Back Inventory Portal</h5>
                                        <p class="text-muted">Sign in to continue to BraveSpark.</p>
                                    </div>
                                    <div class="p-2 mt-4">
                                        <form action="#" id="login-form" class="login-form" method="post" autocomplete="off">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <button type="submit" name="login_btn" id="login_btn" class="btn btn-success w-100 login_btn">Sign In</button>
                                            </div>
...
<script type="text/javascript">
    ...
    var inventory_url = "<?php echo URL::to('/inventory/'); ?>";
</script>
