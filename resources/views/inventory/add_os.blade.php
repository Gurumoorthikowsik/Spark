                        ...
                        <div class="card" id="contactList">
                            <div class="card-header">
                                <div class="row align-items-center g-3">
                                    <div class="col-md-3">
                                        <h5 class="card-title mb-0">Add OS</h5>
                                    </div><!--end col-->
                                    <div class="col-md-auto ms-auto">
                                        <div class="d-flex gap-2">
                                           
                                            <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add OS</button>
                                 ...
                                 <table id="os" class="display nowrap " style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="form_name" scope="col">OS Type</th>                                               
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Add OS</h4>
                    ...
                    <form action="<?php echo URL::to('inventory/'); ?>/add_os_submit" id="add_os" class="laptop-form" method="post" autocomplete="off">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="customername-field" class="form-label"> OS * </label>
                                <input type="text" class="form-control" name="os_name" id="os_name" class="hhhhhh"
                                placeholder="Enter The OS Name">
                            </div>                        
...
<div class="modal fade" id="showModaledit" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 650px;max-height: 500px;">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3"> <h4>Edit OS List</h4>
                        <h5 class="modal-title" id="exampleModalLabel"></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id="close-modal"></button>
                    </div>
                    <form action="<?php echo URL::to('/'); ?>/edit_add_os" id="edit_add-os-form" class="edit_add-os-form" method="post" autocomplete="off">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="customername-field" class="form-label">OS Name * </label>
