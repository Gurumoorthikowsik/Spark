        ...
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                 <div class="flex-grow-1">
                    <h4 class="fs-16 mb-1">{{Dayzone()}}, {{get_user(emp_user_id(),'username')}}!</h4>
                        ...
                        <div class="card gradient-2">
                            <div class="card-body" id="working_hrs_card" style="background-color: #f93c95;border-radius:inherit">
                                ...
                                <div class="d-inline-block">
                                    <h3 class="text-white">{{today_working_hrs(emp_user_id())}}  Hrs:Min </h3>
                                    <h5><p class="text-white mb-5">{{date('d / M / Y')}}</p></h5>
                                </div>
                                ...
                                <div class="card gradient-1">
                                    ...
                                    <div class="card-body">
                                        <marquee  direction = "up" scrollamount="2" onmouseover="stop()" onmouseout="start()">{{site_setting()->news}}</marquee>
                                    </div>
