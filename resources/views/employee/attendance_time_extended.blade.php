                        ...
                        <div class="card">
                            ...
                            <button type="button" class="btn btn-success add-btn float-right" data-toggle="modal" data-target="#addModel" data-whatever="@mdo"><i class="fa fa-plus"></i> Add </button>
                                ...
                                <table id="example" class="display nowrap example" style="width:100%">
                                        ...
                                        <tbody>
                                            @php $i = 1; @endphp
                                            @foreach ($attendance_time_extended->get() as $value)                                     
                                        ...
                                        <td>{{$i}}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="/employees/delete_attendance_time_extended/{{encrypt_decrypt('encrypt',$value->id)}}" data-id="6" title="Delete Permission" class="edit_report"><span class="label label-danger">Delete</span></a>
                                                @else
                                                    --
                                                @endif
                                            <td>
