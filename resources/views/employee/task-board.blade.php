              ...
              <div class="task-board">
                ...
                <div class="column" data-status="0" id="to-do-column">
                    <div class="column-header">
                        ...
                        <span class="task-count" id="to-do-count">{{ $bugs->where('Status', 0)->count() }} Task</span>
                    </div>
                    <div class="card-container-wrapper">
                    <div class="card-container" id="to-do-container">
                        @foreach ($bugs->where('Status', 0) as $bug)
                            <div class="card" id="card-{{ $bug->id }}" draggable="true" data-id="{{ $bug->id }}" data-status="0">
                                <img src="{{ $bug->image }}" alt="">
                                <h4>{{ $bug->bugs_name }}</h4>
                                <p>{{ $bug->bugs_desc }}</p>
                                <div class="tags">
                                    <span class="tag blue">{{ $bug->module_name }}</span>
                ...
                <div class="column" data-status="1" id="in-progress-column">
                    <div class="column-header">
                        ...
                        <span class="task-count" id="in-progress-count">{{ $bugs->where('Status', 1)->count() }} Task</span>
                    </div>
                    <div class="card-container" id="in-progress-container">
                        @foreach ($bugs->where('Status', 1) as $bug)
                            <div class="card" id="card-{{ $bug->id }}" draggable="true" data-id="{{ $bug->id }}" data-status="1">
                                <img src="{{ $bug->image }}" alt="">
                                <h4>{{ $bug->bugs_name }}</h4>
                                <p>{{ $bug->bugs_desc }}</p>
                                <div class="tags">
                ...
                <div class="column" data-status="2" id="development-done-column">
                    <div class="column-header">
                        ...
                        <span class="task-count" id="development-done-count">{{ $bugs->where('Status', 2)->count() }} Task</span>
                    </div>
                    <div class="card-container" id="development-done-container">
                        @foreach ($bugs->where('Status', 2) as $bug)
                            <div class="card" id="card-{{ $bug->id }}" draggable="true" data-id="{{ $bug->id }}" data-status="2">
                                <img src="{{ $bug->image }}" alt="">
                                <h4>{{ $bug->bugs_name }}</h4>
                                <p>{{ $bug->bugs_desc }}</p>
                                <div class="tags">
                ...
                <div class="column" data-status="3" id="task-completed-column">
                    <div class="column-header">
                        ...
                        <span class="task-count" id="task-completed-count">{{ $bugs->where('Status', 3)->count() }} Task</span>
                    </div>
                    <div class="card-container" id="task-completed-container">
                        @foreach ($bugs->where('Status', 3) as $bug)
                            <div class="card" id="card-{{ $bug->id }}" draggable="true" data-id="{{ $bug->id }}" data-status="3">
                                <img src="{{ $bug->image }}" alt="">
                                <h4>{{ $bug->bugs_name }}</h4>
                                <p>{{ $bug->bugs_desc }}</p>
                                <div class="tags">
