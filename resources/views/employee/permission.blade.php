            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Permission Details</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            	<button type="button" class="btn btn-success add-btn float-right" data-toggle="modal" data-target="#addModel" data-whatever="@mdo"><i class="fa fa-plus"></i> Add Permission</button>
                                <br>
                                <h4 class="card-title">{{date('M')}} Month Available Permission</h4>
                                ...
                                <table id="example" class="display nowrap example" style="width:100%">
                                        ...
                                        <tbody>
                                             ...
                                             <?php  $persmission = staff_permission_data(Session::get("empuser_id"));  $persmission_res = json_decode($persmission); ?>
                                           <tr>
                                               <th>1</th>
                                               <th>{{ get_user(Session::get("empuser_id"),'username') }}</th>
                                               <th>{{ encrypt_decrypt("decrypt",get_user(Session::get("empuser_id"),'email')) }}</th>
                                               <th>{{date('M / Y')}}</th>
                                               <th>{{$persmission_res->available}} Min</th>
                                               <th>{{$persmission_res->pending}} Min</th>
                                               <th>{{$persmission_res->approved}} Min</th>
                                           </tr>
                                    </table>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Overall Apply Permission Details</h4>
                                <div class="table-responsive">
                                <table id="example" class="display nowrap example" style="width:100%">
                                        <thead>
                                            <tr>
                                        ...
                                        @php $i = 1; @endphp
                                        @foreach ($permission_details->get() as $value)

                                        <tr class="item">
                                            <td>{{$i}}</td>
                                            <td >{{$value->permission_date}}</td> 
                                            <td >{{$value->from_time}}</td> 
                                            <td>{{$value->to_time}}</td> 
                                            <td>{{$value->hours}} Min</td> 
                                            <td>{{$value->resion}}</td> 
                                            ...
                                            <td>
                                                ...
                                                <a href="/employees/delete_permission/{{encrypt_decrypt('encrypt',$value->id)}}" data-id="6" title="Delete Permission" class="edit_report"><span class="label label-danger">Delete</span></a>
                                                @else
                                                    --
                                                @endif
                                            <td>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
		                 ...
		                 <form action="#" id="permission-form" class="permission-form" method="post" autocomplete="off">
		                {{ csrf_field() }}
                        <br>
			              <div class="col-lg-12">
