<!--**********************************
    ...
    ***********************************-->
    ...
    <script src="{{ URL::to('/') }}/public/assets/calander/employee_calendar.js"></script>
    ...
    <script src="{{ URL::to('/') }}/public/employee/plugins/chart.js/Chart.bundle.min.js"></script>

    <script src="{{ URL::to('/') }}/public/employee/plugins/pg-calendar/js/pignose.calendar.min.js"></script>


    <script src="{{ URL::to('/') }}/public/assets/libs/list.pagination.js/list.pagination.min.js"></script>

    <script src="{{ URL::to('/') }}/public/employee/plugins/tables/js/jquery.dataTables.min.js"></script>

    <script src="{{ URL::to('/') }}/public/employee/plugins/tables/js/datatable/dataTables.bootstrap4.min.js"></script>

    <script src="{{ URL::to('/') }}/public/employee/plugins/tables/js/datatable-init/datatable-basic.min.js"></script>

    <script src="{{ URL::to('/') }}/public/employee/js/bootstrap-datetimepicker.min.js"></script>
