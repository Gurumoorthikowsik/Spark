...
<head>
    ...
    <!-- jsvectormap css -->
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/assets/libs/jsvectormap/css/jsvectormap.min.css'">



    <!--Swiper slider css-->
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/'assets/libs/swiper/swiper-bundle.min.css">
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/assets/css/icons.min.css">


    <!-- App Css-->
    <!-- custom Css-->

    <link rel="stylesheet" href="{{ URL::to('/') }}/public/assets/css/custom.min.css">


    <link rel="stylesheet" href="{{ URL::to('/') }}/public/assets/css/app.min.css?{{ time() }}" type="text/css">
    ...
    <link rel="stylesheet" href="{{ URL::to('/') }}/public/assets/calander/css/calendar.css?{{ time() }}" type="text/css">
...
<!--                 <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('assets/images/logos-sm.png')}}?1" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{URL::to('/public/assets/images/')}}/logo-darks.png?1" alt="" height="17">
                        </span>
                    </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <span
                            class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger">{{$getnotification->count()}}<span class="visually-hidden">unread messages</span></span>
                    </button>
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge badge-soft-light fs-13" > {{$getnotification->count()}}  New</span>
                                    </div>
                                </div>
                            </div>                          
                                ...
                                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true"
                                    ...
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab" role="tab"
                                            aria-selected="true">
                                            All ({{$getnotification->count()}})
                                        </a>
                                    </li> &nbsp&nbsp&nbsp
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link active"  href="{{url('/read_notify')}}"
                                            >
                                            Read All
                                        </a>
                                    </li>
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                ...
                                @foreach ($getnotification->get() as $key => $value)
                                    <div class="text-reset notification-item d-block dropdown-item position-relative active">
                                        <a href="#" class="admin_notification" data-link="{{$value->link}}"  data-id="{{$value->id}}"><div class="d-flex">
                                            <img src="{{URL::to('/public/assets/images/')}}/users/user_icon.png"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                    <h6 class="mt-0 mb-1 fs-13 fw-semibold">{{ $value->title }}</h6>
                                    ...
                                    <!-- <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="{{URL::to('/public/assets/images/')}}/users/avatar-8.jpg"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel"
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="{{URL::to('/public/assets/images/')}}/users/avatar-6.jpg"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel" aria-labelledby="alerts-tab">
                                <div class="w-25 w-sm-50 pt-3 mx-auto">
                                    <img src="{{URL::to('/public/assets/images/')}}/svg/bell.svg" class="img-fluid" alt="user-pic">
                                </div>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{get_user(user_id(),'username')}}</span>
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{get_user(user_id(),'position')}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome {{get_user(user_id(),'username')}}!</h6>
                       ...
                       <!--  <a class="dropdown-item" href="pages-faqs.html"><i
                        ...
                        <a class="dropdown-item" href="{{URL::to('/site_setting')}}"><i
