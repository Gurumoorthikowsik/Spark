 <footer class="footer">
    ...
    <!-- JAVASCRIPT -->
        ...
        <script src="{{ URL::to('/') }}/public/assets/js/jquery.validate.min.js?{{ time() }}"></script>
        ...
        <script src="{{ URL::to('/') }}/public/assets/libs/prismjs/prism.js"></script>


        <script src="{{ URL::to('/') }}/public/assets/libs/list.js/list.min.js"></script>


        <script src="{{ URL::to('/') }}/public/assets/libs/list.pagination.js/list.pagination.min.js"></script>

        <script src="{{ URL::to('/') }}/public/assets/js/pages/crypto-transactions.init.js"></script>

        <script src="{{ URL::to('/') }}/public/assets/js/pages/listjs.init.js"></script>
