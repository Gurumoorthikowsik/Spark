                                 ...
                                 <table id="example" class="display nowrap " style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                @if(page_access(user_id(),'edit_Privileges') == 1)
                                        ...
                                        <tr class="item">
                                            ...
                                            <!-- {{encrypt_decrypt('decrypt',$value->email)}} -->
                                            <td class="role">{{get_roll($value->position)}}</td>
                                            <td class="date">{{date("d-M-Y",strtotime($value->created_date))}}</td>
                                            <td class="status">
                                                @if($value->status == 1)
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <div class="edit">
                                                        <a href="{{URL::to('/edit_privileges')}}/{{encrypt_decrypt('encrypt',$value->userid)}}"><button class="btn btn-sm btn-success edit-item-btn">Edit Access</button></a>
                                                    </div>
