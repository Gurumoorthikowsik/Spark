...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{site_setting()->site_fav}}">
    
    <link href="{{ URL::to('/') }}/public/employee/css/style.css'?"<?php echo time(); ?> />
...
<body class="h-100">
    ...
    ********************-->
                        ...
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <form class="mt-5 mb-5">
                                    ...
                                    ?>
                                    <div class="text-center mb-4 mt-4"><a href="{{url('/')}}{{$uri}}" class="btn btn-primary">Go to Homepage</a>
                                    </div>
                                </form>
    ...
    <!--**********************************
        Scripts
    ***********************************-->
  <script src="{{ asset('employee/plugins/common/common.min.js')}}"></script>
    <script src="{{ asset('employee/js/custom.min.js')}}"></script>
    <script src="{{ asset('employee/js/settings.js')}}"></script>
    <script src="{{ asset('employee/js/gleek.js')}}"></script>
    <script src="{{ asset('employee/js/styleSwitcher.js')}}"></script>
</body>
</html>
