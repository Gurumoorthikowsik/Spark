<!-- footer -->
        ...
        <!-- particles js -->
        <script src="<?php echo e(URL::to('/')); ?>/public/assets/libs/particles.js/particles.js"></script>

        
        <!-- particles app js -->
        <script src="<?php echo e(URL::to('/')); ?>/public/assets/js/pages/particles.app.js"></script>



        <script src="<?php echo e(URL::to('/')); ?>/public/assets/js/pages/password-addon.init.js"></script>
...
</html><?php /**PATH C:\xampp\htdocs\dashboard\code\GIT\Spark\resources\views/common/footer.blade.php ENDPATH**/ ?>