                                 ...
                                 <div class="col-xxl-5 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="username" id="username"
                                            placeholder="Enter The User Name" value="<?php echo e($user->username); ?>">
                                    </div>
                                </div>
                                <!--end col-->
                                    ...
                                    <div>
                                        ...
                                        <div class="form-icon">
                                            <input type="email" class="form-control form-control-icon"
                                                id="email" name="email" placeholder="Enter The Email ID" value="<?php echo e(encrypt_decrypt('decrypt',$user->email)); ?>">
                                ...
                                <div class="col-xxl-5 col-md-6">
                                    <div>
                                        ...
                                        <input type="number" class="form-control" id="phone" name="phone"
                                            placeholder="Enter The Phone Number" value="<?php echo e($user->phone_number); ?>">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-5 col-md-6">
                                    <div>
                                        ...
                                        <input type="email" class="form-control" id="personalemail" name="personalemail"
                                            placeholder="Enter The Personal Email ID" value="<?php echo e($user->personal_email); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('common.inner_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>                                    <?php /**PATH C:\xampp\htdocs\dashboard\code\GIT\Spark\resources\views/profile.blade.php ENDPATH**/ ?>