                                ...
                                <table id="example" class="table table-striped table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                    	  <?php if($report->count() != 0): ?>
	                                       <?php $i = 1; ?>
	                                       <?php $__currentLoopData = $report->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($i); ?></td>
                                                ...
                                                <td><a href="#" data-id="<?php echo e($value->id); ?>" title="Edit Task" class="edit_report"><span class="label label-secondary">Edit</span></a>
                                              
                                                    <td>
      
                                                        <a href="<?php echo e(URL::to('/employees/updateSrccode/' . $value->id)); ?>" class="btn btn-success edit_report text-white">View</a>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="role" id="role" value="<?php echo e($user->position); ?>" readonly>
                            </div> 


                            <div class="mb-3">
                                <label for="email-field" class="form-label d-none">From Mail *</label>
                                <input type="hidden" class="form-control" name="frommail" id="frommail" value="<?php echo e($user->email); ?>" readonly>
                            </div> 
...
</script><?php /**PATH C:\xampp\htdocs\dashboard\code\GIT\Spark\resources\views/employee/working_report.blade.php ENDPATH**/ ?>