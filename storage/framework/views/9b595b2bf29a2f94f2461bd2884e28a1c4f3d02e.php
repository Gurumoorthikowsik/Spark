...
<style>
 ...
 <div class="content-body">
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                  <form action="<?php echo URL::to('/employees/Studentprofileupdate'); ?>" class="form-valide" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="userid" id="userid" class="form-control" placeholder="Enter Student Name" value="<?php echo e($user->userid); ?>">
                                            ...
                                            <div class="row">
                                              <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="employee_id" id="employee_id" class="form-control" placeholder="Enter Student Id" value="<?php echo e($user->employee_id); ?>" readonly>
                                              ...
                                              <div class="col-lg-6">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="username" id="username" class="form-control" placeholder="Enter Student Name" value="<?php echo e($user->username); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="email" id="email" class="form-control" placeholder="Enter email Id" value="<?php echo e(encrypt_decrypt('decrypt',$user->email)); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="department" id="department" class="form-control" placeholder="Enter Student Id" value="<?php echo e($user->department); ?>" readonly>
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="date_join" id="date_join" class="form-control" placeholder="Enter Student Id" value="<?php echo e($user->date_join); ?>" readonly>
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="phone_number" id="phone_number" class="form-control" placeholder="Enter Student Id" value="<?php echo e($user->phone_number); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="College" id="College" class="form-control" placeholder="Enter College Name" value="<?php echo e($user->College); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="College_dep" id="College_dep" class="form-control" placeholder="Enter College Department" value="<?php echo e($user->College_dep); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="Student_year" id="Student_year" class="form-control" placeholder="Enter Student year" value="<?php echo e($user->Student_year); ?>">
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="input-group">
                                                  <input type="text" name="batch_day" id="batch_day" class="form-control" placeholder="Enter Batch week" value="<?php echo e($user->batch_day); ?>" readonly>
                                              ...
                                              <div class="col-lg-6 mt-3">
                                                ...
                                                <div class="profile-container">
                                                  <div class="image-preview">
                                                      ...
                                                      <img id="preview" 
                                                           src="<?php echo e($user->profile_photo ?? asset('employee/images/user/1.png')); ?>" 
    ...
    <form class="form-horizontal" action="<?php echo e(url('employees/ChangePassword')); ?>" method="POST" id="employeechange_pass" enctype="multipart/form-data">                 
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\dashboard\code\GIT\Spark\resources\views/employee/profile.blade.php ENDPATH**/ ?>